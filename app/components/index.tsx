...
const Main: FC = () => {
  ...
  */
  ...
  const [isResponsing, { setFalse: setResponsingTrue, setFalse: setResponsingFalse }] = useBoolean(false)
  ...
  return (
    <div className='bg-gray-900 text-white'>
      ...
      />
      <div className="flex rounded-t-2xl bg-gray-800 overflow-hidden">
        {/* sidebar */}
